    ...
    <div class="inner">
        ...
        <div class="sub_content">
            <div class="mypage_wrap">
                ...
                <form id="termsForm" class="profile_info terms_info" onsubmit="return false;">
                    <div class="tit">개인정보 제3자 제공 동의해주세요</div>

                    <div class="agree">
                        <label>
                            <input type="checkbox" name="agreeOptionalYn"
                                   value="Y" ${sessionScope.userLogin.agreeOptionalYn eq 'Y' ? 'checked' : ''}>
                            <span class="chk_box"></span>
                            <div>[선택] 프로필 정보 추가 수집 동의</div>
                        </label>
                    </div>
                    ...
                    <div class="btn save_btn">
                        <button type="button" onclick="submitTerms()">저장하기</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    function submitTerms() {
        var formData = $('#termsForm').serialize();

        $.ajax({
            type: "POST",
            url: "/mypage/terms/personalProc",
            data: formData,
