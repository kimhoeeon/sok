...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        ...
        <a href="/admin/news/form" class="btn btn-neon px-4"><i class="bi bi-pencil-square"></i> 등록</a>
    </div>
</div>

<div class="premium-dark-card p-4">
    <form id="searchForm" action="/admin/news/list" method="get" class="d-flex justify-content-end mb-4">
                        ...
                        <c:forEach var="item" items="${list}">
                            <tr>
                                ...
                                <td class="text-start border-secondary">
                                    <a href="/admin/news/form?brdSeq=${item.brdSeq}&pageNum=${pageMaker.cri.pageNum}&amount=${pageMaker.cri.amount}&category=${params.category}&searchType=${params.searchType}&searchKeyword=${params.searchKeyword}" class="text-white text-decoration-none fw-bold hover-glow">
                                ...
                                <td class="border-secondary">
                                    <a href="/admin/news/form?brdSeq=${item.brdSeq}&pageNum=${pageMaker.cri.pageNum}&amount=${pageMaker.cri.amount}&category=${params.category}&searchType=${params.searchType}&searchKeyword=${params.searchKeyword}" class="btn btn-sm btn-outline-light me-1">수정</a>
                                    <form action="/admin/news/delete" method="post" style="display:inline;" onsubmit="return confirm('삭제 후 복구가 어렵습니다. 정말 삭제하시겠습니까?');">
