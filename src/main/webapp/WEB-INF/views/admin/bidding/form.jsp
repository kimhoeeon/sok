...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/admin/bidding/list?pageNum=${params.pageNum}&amount=${params.amount}&category=${params.category}&searchKeyword=${params.searchKeyword}" class="btn btn-outline-light"><i class="bi bi-list"></i> 목록</a>
</div>
    ...
    <form action="/admin/bidding/save" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-4 glassmorphism-box p-3">
            <div class="col-md-12 mb-3">
                ...
                <div class="d-flex gap-3 mt-2">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="category" value="진행중" id="cat1" ${bidding.category eq '진행중' or empty bidding.category ? 'checked' : ''}>
                        <label class="form-check-label text-white fw-bold text-success" for="cat1">진행중</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="category" value="마감" id="cat2" ${bidding.category eq '마감' ? 'checked' : ''}>
            ...
            <div class="col-12 mb-3">
                ...
                <input type="text" name="title" class="form-control dark-search-bar" value="${bidding.title}" required placeholder="예) 2026 스페셜올림픽코리아 홈페이지 리뉴얼 용역 입찰 공고">
            </div>
            ...
            <div class="col-12 mb-3">
                ...
                <div class="form-text text-secondary mt-1"><i class="bi bi-info-circle"></i> Ctrl 키를 누른 상태로 제안요청서, 과업지시서, 입찰참가신청서 등을 모두 선택하세요.</div>
