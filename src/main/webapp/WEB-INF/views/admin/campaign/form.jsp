...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <a href="/admin/campaign/list?pageNum=${params.pageNum}&amount=${params.amount}&searchKeyword=${params.searchKeyword}&searchUseYn=${params.searchUseYn}"
...
<div class="premium-dark-card p-4">
    <form action="/admin/campaign/save" method="post" enctype="multipart/form-data" id="campaignForm">
    ...
    <c:if test="${not empty campaign.campSeq}">
        <form id="deleteForm" action="/admin/campaign/delete" method="post" style="display:none;">
            <input type="hidden" name="campSeq" value="${campaign.campSeq}">
            <input type="hidden" name="pageNum" value="${params.pageNum}">
            <input type="hidden" name="amount" value="${params.amount}">
        </form>
