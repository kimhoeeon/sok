...
<div class="premium-dark-card p-4">
    <form id="searchForm" action="/admin/management/list" method="get" class="d-flex justify-content-end mb-4">
                        ...
                        <c:forEach var="item" items="${list}">
                            <tr>
                                ...
                                <td class="text-start border-secondary">
                                    <a href="/admin/management/form?brdSeq=${item.brdSeq}&pageNum=${pageMaker.cri.pageNum}&amount=${pageMaker.cri.amount}&category=${params.category}&searchKeyword=${params.searchKeyword}" class="text-white text-decoration-none fw-bold hover-glow">
                                        ${item.title}
                                    </a>
                                </td>
                                ...
                                <td class="border-secondary">
                                    <a href="/admin/management/form?brdSeq=${item.brdSeq}&pageNum=${pageMaker.cri.pageNum}&amount=${pageMaker.cri.amount}&category=${params.category}&searchKeyword=${params.searchKeyword}" class="btn btn-sm btn-outline-light me-1">수정</a>
