                    ...
                    <c:otherwise>
                        <c:forEach var="item" items="${list}">
                            <tr>
                                ...
                                <td class="border-secondary">
                                    <a href="/mng/volunteer/detail?volSeq=${item.volSeq}&pageNum=${pageMaker.cri.pageNum}&amount=${pageMaker.cri.amount}&searchSupportArea=${params.searchSupportArea}&searchKeyword=${params.searchKeyword}" class="btn btn-sm btn-outline-light">상세보기</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </c:otherwise>
