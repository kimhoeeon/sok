...
<div class="premium-card p-4">
    <form id="searchForm" action="/mng/bidding/list" method="get" class="d-flex justify-content-end mb-4">
        ...
        <table class="table table-hover align-middle text-center mb-0" style="--bs-table-bg: #ffffff; --bs-table-color: #212529; --bs-table-hover-bg: rgba(0,0,0,0.02); border-top: 1px solid #dee2e6;">
            <thead style="background-color: #f8f9fa;">
                <tr>
                    ...
                    <th class="text-dark border-bottom py-3">입찰 공고명</th>
            ...
            <tbody style="border-top: 2px solid #dee2e6;">
                <c:choose>
                    <c:when test="${empty list}">
                        <tr>
                            <td colspan="6" class="py-5 text-muted">등록된 입찰 공고가 없습니다.</td>
                        </tr>
                    </c:when>
                    <c:otherwise>
