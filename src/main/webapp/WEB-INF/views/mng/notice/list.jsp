                    ...
                    <c:otherwise>
                        <c:forEach var="item" items="${list}">
                            <tr>
                                ...
                                <td class="text-start">
                                    <a href="/mng/notice/form?brdSeq=${item.brdSeq}&pageNum=${pageMaker.cri.pageNum}&amount=${pageMaker.cri.amount}&category=${params.category}&searchType=${params.searchType}&searchKeyword=${params.searchKeyword}" class="text-dark text-decoration-none fw-bold hover-glow">
