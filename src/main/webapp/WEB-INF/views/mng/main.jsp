...
<style>
    /* 빠른 업무 이동 (Quick Links) 호버 애니메이션 효과 */
    .quick-link-card {
        background: #ffffff;
    ...
    .quick-link-card:hover {
        ...
        box-shadow: 0 10px 20px rgba(0, 158, 247, 0.12) !important;
        border-color: rgba(0, 158, 247, 0.3);
    }
    .quick-link-card .quick-link-icon, .quick-link-card span {
        transition: all 0.3s ease;
    }
...
<div class="row align-items-center mb-4">
    <div class="col-md-8">
        <h3 class="fw-bold text-dark mb-1">통합 운영 현황</h3>
    ...
    <div class="col-md-4 text-end">
        <div class="d-inline-flex align-items-center p-2 px-3 rounded glassmorphism-box border border-danger" style="transform: scale(0.9); transform-origin: right;">
            ...
            <span class="text-dark fw-semibold me-2" style="font-size: 12px;">미처리 유지보수 티켓</span>
...
<div class="row g-3 mb-4">
    <div class="col-xl-3 col-md-6">
        <div class="premium-card p-4 h-100 border-0 shadow-sm">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <span class="text-dark fw-semibold d-block mb-1" style="font-size: 13px;">오늘 방문자</span>
                ...
                <div class="p-3 bg-success bg-opacity-10 rounded-circle"><i class="bi bi-person-lines-fill text-success fs-3"></i></div>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-md-6">
        <div class="premium-card p-4 h-100 border-0 shadow-sm">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <span class="text-dark fw-semibold d-block mb-1" style="font-size: 13px;">누적 방문자</span>
                    <h2 class="text-dark fw-bold mb-0"><fmt:formatNumber value="${summary.totalVisitor}" pattern="#,###"/> <small class="fs-6 opacity-50">명</small></h2>
                </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="premium-card p-4 h-100 border-0 shadow-sm">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <span class="text-dark fw-semibold d-block mb-1" style="font-size: 13px;">누적 후원자</span>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="premium-card p-4 h-100 border-0 shadow-sm">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <span class="text-dark fw-semibold d-block mb-1" style="font-size: 13px;">누적 후원액</span>
...
<div class="row g-4 mb-4">
    <div class="col-xl-8">
        <div class="premium-card p-4 h-100 overflow-hidden">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="fw-bold text-dark m-0"><i class="bi bi-activity me-2 text-success"></i>방문자 현황</h5>
            ...
            <div id="visitorLineChart" class="w-100" style="min-height: 360px;"></div>
        </div>
    </div>

    <div class="col-xl-4">
        <div class="premium-card p-4 h-100 d-flex flex-column">
            <h5 class="fw-bold text-dark mb-4"><i class="bi bi-fire me-2 text-danger"></i>인기 페이지 TOP 5</h5>
...
<div class="row g-4 mb-4">
    <div class="col-xl-8">
        <div class="premium-card p-4 h-100 d-flex flex-column overflow-hidden">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="fw-bold text-dark m-0"><i class="bi bi-journal-check me-2 text-warning"></i>신청/참여 현황</h5>
            ...
            <div id="applyBarChart" class="flex-grow-1 w-100" style="min-height: 350px;"></div>

            <div class="row mt-auto pt-3 border-top border-secondary border-opacity-10">
                <div class="col-6 border-end border-secondary border-opacity-10 text-center">
                    <span class="text-muted d-block fw-semibold mb-1" style="font-size: 12px;">누적 후원 신청액</span>
                    <span class="text-dark fw-bold fs-5"><fmt:formatNumber value="${summary.totalDonationAmt}" pattern="#,###"/> <small class="text-muted fs-6">원</small></span>
                </div>
                <div class="col-6 text-center">
                    <span class="text-muted d-block fw-semibold mb-1" style="font-size: 12px;">누적 후원 참여자</span>
                    <span class="text-dark fw-bold fs-5"><fmt:formatNumber value="${summary.totalDonorCnt}" pattern="#,###"/> <small class="text-muted fs-6">명</small></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-4">
        <div class="premium-card p-4 h-100 d-flex flex-column">
            <h5 class="fw-bold text-dark mb-4"><i class="bi bi-server me-2 text-info"></i>JVM & 웹 서버 상태</h5>
            ...
            <div class="text-center mb-4 p-3 rounded" style="background: rgba(57, 255, 20, 0.05); border: 1px dashed rgba(57, 255, 20, 0.2);">
                ...
                <h3 class="text-dark fw-bold m-0" id="liveServerTime" style="letter-spacing: 2px;">00:00:00</h3>
                <span class="text-dark fw-semibold" style="font-size: 11px;" id="liveServerDate">YYYY-MM-DD</span>
            </div>

            <div class="mb-4 p-4 rounded flex-grow-1 d-flex flex-column justify-content-center shadow-sm" style="background-color: #f8f9fa; border: 1px solid #e9ecef;">
                <div class="d-flex justify-content-between mb-3 border-bottom border-secondary border-opacity-10 pb-3">
                    <span class="text-secondary fw-semibold" style="font-size: 13px;">호스팅 환경</span>
                    <span class="text-dark fw-bold" style="font-size: 13px;">Cafe24 Tomcat JSP</span>
                </div>
                <div class="d-flex justify-content-between mb-3 border-bottom border-secondary border-opacity-10 pb-3">
                    <span class="text-secondary fw-semibold" style="font-size: 13px;">DB 연결상태</span>
                    <c:choose>
                ...
                <div class="d-flex justify-content-between mb-3 border-bottom border-secondary border-opacity-10 pb-3">
                    <span class="text-secondary fw-semibold" style="font-size: 13px;">서버 구동 시간</span>
                    <span class="text-warning fw-bold" style="font-size: 13px;"><i class="bi bi-clock-history me-1"></i>${jvmUptime}</span>
                </div>
                <div class="d-flex justify-content-between">
                    <span class="text-secondary fw-semibold" style="font-size: 13px;">Java 버전</span>
            ...
            <div class="mt-auto pt-2">
                <div class="d-flex justify-content-between mb-2">
                    <label class="text-dark fw-semibold" style="font-size: 12px;"><i class="bi bi-memory me-1"></i>자바 힙 메모리 (JVM Memory)</label>
                    <span class="text-dark fw-bold" style="font-size: 12px;">${jvmUsage}% (${jvmUsedMB}MB / ${jvmTotalMB}MB)</span>
                </div>
...
<div class="premium-card p-4 mb-0 shadow-sm">
    ...
    <div class="row g-3 text-center">
        ...
        <c:forTokens items="${links}" delims="," var="link" varStatus="st">
            <div class="col-lg-2 col-md-4 col-6">
                <a href="/mng/${link}/list" class="d-block p-4 rounded text-decoration-none quick-link-card">
                    <i class="bi bi-${linkIcons.split(',')[st.index]} fs-1 d-block mb-2 text-dark quick-link-icon"></i>
                    <span class="text-dark fw-semibold" style="font-size: 13px;">${linkNames.split(',')[st.index]}</span>
                </a>
            </div>
        </c:forTokens>
    </div>
...
<script>
    ...
    function initCharts() {
        // 공통 옵션에서 height 속성을 제거하여, 개별 차트에서 높이를 다르게 지정할 수 있도록 수정
        var commonOptions = {
            chart: {
                width: '100%',
                toolbar: {show:false},
            ...
            theme: { mode: 'light' },
            xaxis: {
                labels: { style: { colors: '#333333', fontSize: '12px' } }
            },
            yaxis: {
                labels: { style: { colors: '#333333', fontSize: '12px' } }
            },
            grid: {
                ...
                padding: { top: 10, right: 20, bottom: 20, left: 15 }
            },
            noData: {
        ...
        // 방문자 현황 차트: 고정 높이 320px 지정
        visitorChart = new ApexCharts(document.querySelector("#visitorLineChart"), {
            ...commonOptions,
            series: [],
            chart: { ...commonOptions.chart, type: 'area', height: 360 },
            colors: ['#39ff14'],
        ...
        // 신청/참여 현황 차트: 부모 높이에 맞게 늘어나도록 100% 지정
        applyChart = new ApexCharts(document.querySelector("#applyBarChart"), {
            ...commonOptions,
            series: [],
            chart: { ...commonOptions.chart, type: 'bar', stacked: false, height: '100%' },
    ...
    function loadVisitorChart(period, btn) {
        ...
        $.get("/mng/api/stats/visitor?period=" + period, function(data) {
            if(!data || data.length === 0) {
                ...
                visitorChart.updateOptions({
                    series: [{
                        name: '방문자 수',
                        data: data.map(item => item.cnt || item.CNT)
                    }],
                    xaxis: {
                        categories: data.map(item => item.label || item.LABEL)
                    }
                });
            }
        });
    ...
    function loadApplyChart(period, btn) {
        if(btn) setActive(btn);
        $.get("/mng/api/stats/apply?period=" + period, function(data) {
            if(!data || data.length === 0) {
                applyChart.updateSeries([]);
            } else {
                applyChart.updateOptions({
                    series: [
