                    ...
                    <c:otherwise>
                        <c:forEach var="item" items="${list}">
                            <tr>
                                ...
                                <td class="text-start">
                                    <a href="/mng/report/form?brdSeq=${item.brdSeq}&pageNum=${pageMaker.cri.pageNum}&amount=${pageMaker.cri.amount}&category=${params.category}&searchKeyword=${params.searchKeyword}" class="text-dark text-decoration-none fw-bold hover-glow">
                                        ${item.title}
                                    </a>
                                </td>
                                <td>${item.viewCnt}</td>
