        ...
        <div class="premium-card p-5 h-100">
            <div class="d-flex justify-content-between align-items-start border-bottom border-secondary pb-4 mb-4">
                <div>
                    ...
                    <h3 class="text-dark fw-bold mt-2 mb-0">${request.title}</h3>
                </div>
                <div class="text-end">
                    <span class="d-block text-muted" style="font-size: 12px;">작성자: <span class="text-dark fw-bold">${request.regId}</span></span>
            ...
            <c:if test="${not empty request.fileList}">
                <div class="p-3 rounded" style="background: rgba(255,255,255,0.05); border: 1px solid #474761;">
                    <h6 class="text-dark fw-bold mb-3"><i class="bi bi-paperclip me-2"></i>요청 첨부파일</h6>
        ...
        <div class="premium-card p-4 h-100 glassmorphism-box border-0">
            ...
            <c:if test="${isDeveloper}">
                ...
                <form action="/mng/dev/updateStatus" method="post">
                    ...
                    <div class="mb-3">
                        <label class="text-dark mb-2" style="font-size: 13px;">상태 변경</label>
                        <select name="status" class="form-select search-bar border-danger">
                    ...
                    <div class="mb-4">
                        <label class="text-dark mb-2" style="font-size: 13px;">완료 예정일 셋팅</label>
                        <input type="date" name="dueDt" class="form-control search-bar" value="<fmt:formatDate value='${request.dueDt}' pattern='yyyy-MM-dd' />">
                    </div>
...
<div class="premium-card p-5">
    <h5 class="fw-bold text-dark mb-4 border-bottom border-secondary pb-3"><i class="bi bi-chat-dots-fill me-2 text-info"></i> 피드백 및 진행 상황 코멘트</h5>
    ...
    <div class="p-4 rounded" style="background-color: #1e1e2d; border: 1px solid #39ff14;">
        ...
        <form action="/mng/dev/saveComment" method="post" enctype="multipart/form-data">
            ...
            <textarea name="content" class="form-control search-bar mb-3" rows="4" required placeholder="진행 상황 피드백이나 추가 요청 사항을 작성해 주세요."></textarea>
