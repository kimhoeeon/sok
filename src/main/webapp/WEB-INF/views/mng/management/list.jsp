...
<div class="premium-card p-4">
    <form id="searchForm" action="/mng/management/list" method="get" class="d-flex justify-content-end mb-4">
        ...
        <div class="input-group shadow-sm" style="max-width: 600px;">
            ...
            <input type="text" name="searchKeyword" class="form-control search-bar border-start-0" placeholder="제목 검색" value="${params.searchKeyword}">
        ...
        <table class="table table-hover align-middle text-center mb-0" style="--bs-table-bg: #ffffff; --bs-table-color: #212529; --bs-table-hover-bg: rgba(0,0,0,0.02); border-top: 1px solid #dee2e6;">
            <thead style="background-color: #f8f9fa;">
                <tr>
                    ...
                    <th width="12%" class="text-dark border-bottom py-3">분류</th>
                    ...
                    <c:otherwise>
                        <c:forEach var="item" items="${list}">
                            <tr>
                                ...
                                <td class="text-start">
                                    <a href="/mng/management/form?brdSeq=${item.brdSeq}&pageNum=${pageMaker.cri.pageNum}&amount=${pageMaker.cri.amount}&category=${params.category}&searchKeyword=${params.searchKeyword}" class="text-dark text-decoration-none fw-bold hover-glow">
                                        ${item.title}
                                    </a>
                                </td>
                                <td>${item.viewCnt}</td>
