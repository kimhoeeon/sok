    ...
    <div class="inner">
        ...
        <div class="sub_content">
            ...
            <div class="contest_info">
                <div class="txt">국제통합스포츠대회는 발달장애인과 비장애인이 함께하는 국제대회로서 <br />
                    스페셜올림픽코리아의 공모사업으로 운영되는 통합스포츠단 및 스페셜올림픽동아시아본부(SOEA) 소속 통합스포츠팀이 참가하여 그간 쌓아온 기량을 선보이는 대회입니다. <br />
                    대회 결과는 각종 스페셜올림픽 통합스포츠 국제대회의 국가대표 선수 선발자료로 활용됩니다.
                </div>
                <div class="video">
