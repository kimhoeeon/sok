        ...
        <div class="sub_content">
            ...
            <div class="contest">
                <ul class="contest_tab column">
                    ...
                    <li class="on"><a href="/business/sports/other-hap">선수건강증진프로그램(HA)</a></li>
                </ul>
            </div>
            ...
            <div class="contest_info">
                <div class="txt">선수건강증진프로그램은 대회에 참여한 스페셜올림픽 선수들에게 전문 의료진이 무료 의료서비스를 제공하여 <br/>
                    ...
                    총 6종목의[Opening Eyes(눈), Special Smiles(구강), Healthy Hearing(청력), Health Promotion(영양, 건강), Fit Feet(발, 보행), Fun Fitness(운동능력)] 검진을 실시하고 있습니다.
                </div>
                <div class="video">
