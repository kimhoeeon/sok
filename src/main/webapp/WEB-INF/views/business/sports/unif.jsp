        ...
        <div class="sub_top depth_2">
            <div class="sub_top_box">
                <div class="sub_top_nav">
                    <span>사업소개</span><span>스포츠</span><span>통합스포츠</span>
                </div>
        ...
        <div class="sub_content">
            ...
            <div class="contest_info">
                <div class="txt">통합스포츠는 발달장애인과 비장애인이 한 팀을 이루어 훈련하고, 경기에 참가하며 <br />
                    서로를 이해하고 기량을 향상시키는 스포츠 활동으로서 스페셜올림픽 국제본부(SOI)가 중점적으로 진행하고 있는 프로그램입니다. <br />
                    이에 스페셜올림픽코리아에서는 매년 36개의 통합스포츠단 운영을 지원하고 있습니다.<br /><br />
                    ※ 지원 종목: 총 5종목(통합농구, 통합배구, 통합축구, 통합플로어볼, 통합배드민턴)
                </div>
                <div class="video">
                    <div class="embed-container">
                        <iframe src='https://www.youtube.com/embed/GTpNNTJI_bMGTpNNTJI_bM?mute=1&controls=0&loop=1&playlist=GTpNNTJI_bM' frameborder='0' allowfullscreen></iframe>
                    </div>
                </div>
            </div>
