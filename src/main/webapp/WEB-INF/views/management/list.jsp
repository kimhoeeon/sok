        ...
        <div class="sub_top depth_2">
            <div class="sub_top_box">
                <div class="sub_top_nav">
                    <span>뉴스·자료</span><span>경영공시</span>
                </div>
        ...
        <div class="sub_content board_wrap">
            <div class="board_top">
                ...
                <div class="search_box">
                    <form action="/management/list" method="get" id="searchForm" class="search_box">
                        ...
                        <c:otherwise>
                            <c:forEach var="item" items="${list}">
                                <li class="${item.isNotice eq 'Y' ? 'import' : ''}"
                                    onclick="location.href='/management/detail?brdSeq=${item.brdSeq}'"
